...
(function(){
  ...
  const translations = {
   ...
   "about.lead":"⸻\n\n✨ من نحن\n\nنحن منصة استشارات متكاملة نُقدّم تجربة مختلفة في التوجيه وصناعة القرار، نُمكّن الأفراد والشركات من التحرك بثقة نحو أهدافهم، وبناء مسارات أكثر توازنًا ونجاحًا.\n\nنبتكر حلولًا استشارية مُصممة بعناية، ترتكز على فهم عميق، ودقة في التفاصيل، وبساطة تُحدث فرقًا حقيقيًا",
